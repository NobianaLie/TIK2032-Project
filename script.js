...
document.addEventListener('DOMContentLoaded', function() {
    ...
    blogPosts.forEach(post => {
        ...
        commentSection.innerHTML = `
            ...
            <div class="comment-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="comment-name" placeholder="Nama Anda">
                </div>
                <div class="form-group">
                    <label for="comment-text">Komentar</label>
                    <textarea id="comment-text" rows="4" placeholder="Tulis komentar Anda..."></textarea>
                </div>
        ...
        commentSection.style.paddingTop = '20px';
        
        // Tambahkan section komentar ke blog post
        ...
        submitBtn.addEventListener('click', function() {
            ...
            const commentInput = commentSection.querySelector('#comment-text');
            ...
            commentSection.querySelector('.comments-list').appendChild(newComment);
